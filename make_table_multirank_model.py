...
class AudioModel(nn.Module):
    def __init__(self, num_classes, rep, modality_dropout):
        ...
        self.fc_common = nn.Linear(256, 16)
        self.fc_ps = nn.Linear(16, 11)
        self.others = nn.ModuleList([nn.Linear(16, iii) for iii in range_levels.values()])
    ...
    def forward(self, x1, kk):
        ...
        for i in range(len(self.others)):
            x_others.append(self.others[i](x))
        return x_ps, x_others
