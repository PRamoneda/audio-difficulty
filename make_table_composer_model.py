...
if __name__ == '__main__':
    compute_model_basic("audio_midi_cqt5composer_v1", "cqt5", modality_dropout=False)
    compute_model_basic("audio_midi_pr5composer_v1", "pianoroll5", modality_dropout=False)
